        ...
        function montarGuia(viaTexto) {
            ...
            '<div class="bali-guide3-page bali-guide3-page-' + guiaMarca.slug + '" style="--bali-guide-brand:' + guiaMarca.cor + '">',
                ...
                '<div class="bali-guide3-list">',
                    ...
                    linhaChecklist('<strong>LICENCIAMENTO (DOCUMENTO F&Iacute;SICO)</strong> - IPVA <strong class="bali-guide3-year">' + anoAtual + '</strong>, licenciamento, seguro obrigat&oacute;rio e demais encargos devem estar pagos ou regularizados. Parcelamentos e d&iacute;vidas ativas s&atilde;o de responsabilidade do cliente.', 'bali-guide3-ipva'),
