...
public partial class veiculos_Pint_Contrato : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ContratoAuditoria.Registrar("BYD", "VN", contrato, Convert.ToString(Session["id"] ?? ""), Convert.ToString(Session["usuario"] ?? ""), Request.UserHostAddress ?? "", Request.RawUrl ?? "", "IMPRIMIR_CONTRATO", "Contrato=" + contrato + "; Tipo=VN; Marca=BYD; Pagina=Print-ContratoVNBYD.aspx", "", "");
        ...
        {
            ContratoImpressao.RegistrarErro(this, "BYD", "VN", contrato, ex);
            ContratoImpressao.ExibirContratoNaoLocalizado(this, "./contrato.aspx");
            return;
        }
