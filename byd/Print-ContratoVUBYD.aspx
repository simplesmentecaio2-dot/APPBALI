<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print-ContratoVUBYD.aspx.cs" Inherits="veiculos_Pint_Contrato" %>
...
<body>
                ...
                <table border="1" cellspacing="0" style="width: 18.2cm;">
                    ...
                    <tr>
                     ...
                     <asp:Label ID="lblDiaPromissoria" runat="server" CssClass="form-contrato" Text="Label"></asp:Label>
                            pagarei por esta única via de Nota Promissória a Bali Eletrics LTDA CNPJ 54.168.855/0001-55 ou à sua ordem, a quantia de
 ...
 indevido, imperícias, negligências e abuso do veículo, após  ter sido retirado da Concessionária.
        ...
        <asp:Panel ID="Panel1" runat="server" Width="100%" Height="100%">
           ...
           <%-- <img src="../img/header-contratoBYD.png" style="width: 20cm;" />--%>
          ...
          <%--  <span style="font-size: 17px;">
                ...
                <asp:Label ID="lblDeclaracaoCarro" runat="server" CssClass="form-aviso" Text="Label"></asp:Label><br />
                    ...
                    &nbsp;a concessionária Bali Eletrics Ltda, atentendo as disposições previstas na Lei nº 13.111/15 me informou previamente:<br />
                    <br />
...
<asp:Panel ID="guiadocomprador" runat="server" Width="100%" Height="100%" visible="false" >
            ...
            <br />
                    <span style="font-size: 17px;">
                    <img src="../img/GUIDADOCOMPRADORBYD.PNG" style="height: 695px; width: 628px;" />
                    </span>
