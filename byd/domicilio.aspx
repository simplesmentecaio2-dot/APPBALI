<%@ Page Language="C#" AutoEventWireup="true" CodeFile="domicilio.aspx.cs" Inherits="veiculos_Recibo_desconto" %>
...
<head runat="server">
    <title>Domicílio BYD - Bali</title>
        ...
        <div>
            ...
            <div id="menu">
                ...
                <div style="text-align: right; margin-right: 15px;">
                    <asp:Label ID="lblFrmID" runat="server" Text="Domicílio BYD"></asp:Label>
                </div>
            </div>
