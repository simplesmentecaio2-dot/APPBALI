<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dashboard_acompanhamento.aspx.cs" Inherits="veiculos_contrato" %>
...
<body>
    <form id="form1" class="needs-validation" runat="server" novalidate="novalidate">
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"
            ConnectionString="<%$ ConnectionStrings:APPConnectionString %>" SelectCommand="gerencia_vendedor2" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSource2" runat="server"
         ...
         <asp:SqlDataSource ID="SqlDataSource3" runat="server"
            ConnectionString="<%$ ConnectionStrings:APPConnectionString %>"
            SelectCommand="prospeccao_equipe_po" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:ControlParameter Name="evento" ControlID="ddlEventoDashEvt" PropertyName="Value"
                    DefaultValue="" ConvertEmptyStringToNull="false" />
            </SelectParameters>
        </asp:SqlDataSource>
                                    ...
                                    <div class="page-title-wrapper">
                                        <div class="page-title-heading">
                                            <div class="page-title-icon">
                                                <i class="fas fa-user-check icon-gradient bg-dark"></i>
                                            </div>
                                            <div>
                                                <b>Dashboard Acompanhamento</b>
                                        ...
                                        <div class="page-title-actions">
                                            ...
                                            <select id="ddlLojaDashEvt" name="ddlLojaDashEvt" class="btn-shadow mr-3 btn btn-info font-weight-bold" runat="server">
                                            ...
                                            <label for="ddlEventoDashEvt">Equipe:</label>
                                            <select id="ddlEquipe" name="ddlEquipe" class="btn-shadow mr-3 btn btn-dark text-uppercase" runat="server" datasourceid="SqlDataSource3" datatextfield="equipe" datavaluefield="equipe">
                                            </select>

                                            <button class="btn btn-primary btn-lg" runat="server" id="btnAtualizaDash" onclick="btnShowData">
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        ...
                                        <div class="col-md-4 col-xl-4">
                                            <div class="card mb-3 widget-content bg-success">
                                                <div class="widget-content-wrapper text-white">
                                                    <div> <i class="fa fa-address-book mr-2 fa-2x"></i></div>
                                                    <div class="widget-content-left">
                                                        <div class="widget-heading">Disponível</div>
                                                        <div class="widget-subheading">Total de contatos disponíveis</div>
                                                    </div>
                                                    <div class="widget-content-right">
                                                        <div class="widget-numbers text-white">
                                                            <span>
                                                                <asp:Literal ID="txtClientesDisponivel" runat="server"></asp:Literal></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4 col-xl-4">
                                            <div class="card mb-3 widget-content bg-night-sky">
                                                <div class="widget-content-wrapper text-white">
                                                    <div> <i class="fa fa-comments mr-2 fa-2x"></i></div>
                                                    <div class="widget-content-left">
                                                        <div class="widget-heading">Em tratativa</div>
                                                        <div class="widget-subheading">Total em tratativa</div>
                                                    </div>
                                                    <div class="widget-content-right">
                                                        <div class="widget-numbers text-white">
                                                            <span>
                                                                <asp:Literal ID="txtTotalTratativa" runat="server"></asp:Literal></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4 col-xl-4">
                                            <div class="card mb-3 widget-content bg-asteroid">
                                                <div class="widget-content-wrapper text-white">
                                                    <div> <i class="fa fa-phone-alt mr-2 fa-2x"></i></div>
                                                    <div class="widget-content-left">
                                                        <div class="widget-heading">Ligações</div>
                                                        <div class="widget-subheading">Total de ligações realizadas</div>
                                                    </div>
                                                    <div class="widget-content-right">
                                                        <div class="widget-numbers text-white">
                                                            <span>
                                                                <asp:Literal ID="txtTotalLigacoes" runat="server"></asp:Literal></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4 col-xl-4">
                                            <div class="card mb-3 widget-content bg-grow-early">
                                                <div class="widget-content-wrapper text-white">
                                                    <div> <i class="fa fa-thumbs-up mr-2 fa-2x"></i></div>
                                                    <div class="widget-content-left">
                                                        <div class="widget-heading">Convites</div>
                                                        <div class="widget-subheading">Total de convites enviados.</div>
                                                    </div>
                                                    <div class="widget-content-right">
                                                        <div class="widget-numbers text-white">
                                                            <span>
                                                                <asp:Literal ID="txtTotalConvites" runat="server"></asp:Literal></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                       ...
                                       <div class="col-md-4 col-xl-4">
                                            <div class="card mb-3 widget-content bg-warning">
                                                <div class="widget-content-wrapper text-dark">
                                                    <div> <i class="fa fa-retweet mr-2 fa-2x"></i></div>
                                                    <div class="widget-content-left">
                                                        <div class="widget-heading">Recontato</div>
                                                        <div class="widget-subheading">Total de Recontatos.</div>
                                                    </div>
                                                    <div class="widget-content-right">
                                                        <div class="widget-numbers text-white">
                                                            <span>
                                                                <asp:Literal ID="txtTotalRecontato" runat="server"></asp:Literal></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4 col-xl-4">
                                            <div class="card mb-3 widget-content bg-danger">
                                                <div class="widget-content-wrapper text-white">
                                                    <div> <i class="fa fa-trash-alt mr-2 fa-2x"></i></div>
                                                    <div class="widget-content-left">
                                                        <div class="widget-heading">Descartes</div>
                                                        <div class="widget-subheading">Total de Descartes.</div>
                                                    </div>
                                                    <div class="widget-content-right">
                                                        <div class="widget-numbers text-white">
                                                            <span>
                                                                <asp:Literal ID="txtTotalDescartes" runat="server"></asp:Literal></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
