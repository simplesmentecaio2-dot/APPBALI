<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Recibo_descontoBYD.aspx.cs" Inherits="veiculos_Recibo_desconto" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div id="topo">
                <table id="table-menu">
                    <tr>
                        <td id="table-menu-logo"><font id="logo" style="font-family: Arial black; font-size: 32px; font-style: italic; color: white; margin-left: 13px;"><a href="../../Default.aspx" class="linkHome">BYD</a></font><font style="font-family: Calibri; font-size: 14px; margin-left: 5px; font-style: italic; color: white;">APP</font><%--<img src="img/logo4.png" style="margin-left:13px; margin-top:-10px; height: 78px; width: 161px;" />--%></td>
                                    ...
                                    <div style="border: 1px solid #111;">
                                        ...
                                        <table style="width: 100%; border-collapse: collapse; font-size: 13.5px;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 5px 7px; border: 1px solid #111;" colspan="3"><asp:Label ID="Label1" Font-Bold="True" runat="server" Text="BALI AUTO ELETRICS LTDA"></asp:Label></td>
