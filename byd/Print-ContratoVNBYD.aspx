<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print-ContratoVNBYD.aspx.cs" Inherits="veiculos_Pint_Contrato" %>
...
&nbsp;&nbsp;&nbsp;
        ...
        <asp:Panel ID="Panel1" runat="server" Width="100%" Height="100%">
            ...
            <div style="width: 19cm; border: 1px solid black; font-family: 'Times New Roman'; padding: 20px;" id="Declaracao">
                ...
                <asp:Label ID="lblDeclaracaoChassiPlaca" CssClass="form-aviso" runat="server" Text="Label"></asp:Label>, a concession&aacute;ria Bali Eletrics Ltda. informou previamente, de forma clara e adequada:<br /><br />
