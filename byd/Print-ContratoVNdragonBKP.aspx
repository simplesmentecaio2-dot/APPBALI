<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print-ContratoVNdragon.aspx.cs" Inherits="veiculos_Pint_Contrato" %>
        ...
        <asp:Panel ID="pnlImpressao" runat="server" Visible="true" Style="font-family: Arial; font-size: 9px; margin-top: 34px;" Width="100%" Height="50%">
              <div style="width: 19cm; border: 1px solid black; font-family: 'Times New Roman'; padding: 20px;" id="Div1">
                  ...
                  <table border="0" cellspacing="0" style="width: 18.2cm;">
                      <caption>
                          <tr>
                              <td>
                                   <img src="../img/contratodragon.png" style="width: 18cm;" />
                              </td>
                          </tr>
                      </caption>
                      </tr>
            ...
            <table border="1" cellspacing="0" style="width: 18.2cm;">
                ...
                <tr><td>VALOR USADO AVALIAÇÃO:</td>
                    <td><asp:TextBox ID="txtVlusadoAvaliacao" CssClass="form-contrato" runat="server" Height="16px"></asp:TextBox></td>
                    <td>Quitação:</td>
                    <td colspan="2"><asp:TextBox ID="txtvlQuitacao" CssClass="form-contrato" runat="server" Height="16px"></asp:TextBox></td>
                    <td >Saldo da Avaliação:</td>
                    <td colspan="2"><asp:TextBox ID="txtSaldoAvaliacao" CssClass="form-contrato" runat="server" Height="16px"></asp:TextBox></td>                
                ...
                <tr>
                    <td><span style="font-size:11px; ">1) Autorizo a Dragon Motors a faturar em meu nome e CPF o (s) veiculo (s) objeto do presente contrato nas condições de preço e forma de pagamento acima descrito.<br />
                     ...
                     <br />
                        ...
                        4)  Os preços e os itens de série da tabela SSANGYONG estão sujeitos a alteração, conforme tabela de preços da fabrica vigentes à data de  faturamento do(s) veiculo(s).<br />
                     ...
                     <asp:Label ID="lblPlaca" runat="server"  CssClass="form-contrato" Text=""></asp:Label>
                        ...
                        7) O IPVA 2020 será isento desde que o cliente atenda as regras da Lei Distrital Nº 4.733/2011. Essa condição não contempla Seg. Obrigatório 2020;<br />
                        8) Estou ciente que a contratação do serviço de emplacamento e despachante oferecido pela Dragon é opcional, e que esse serviço poderá ser feito diretamente junto ao Detran/DF.
                ...
                <tr>
                    <td colspan="2"><span style="font-size:11px; ">Vencimento:
                     ...
                     <asp:Label ID="lblDiaPromissoria" runat="server" CssClass="form-contrato" Text="Label"></asp:Label>
                        pagarei por esta única via de Nota Promissória a Dragon Motors LTDA CNPJ 72.624.521/0005-54 ou à sua ordem, a quantia de
            ...
            <table border="1" cellspacing="0" style="width: 18.2cm;">
                ...
                <tr>
                    ...
                    <td colspan="5">
                        <asp:TextBox ID="txtFormasPagamento2" CssClass="form-contrato" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>AVALIAÇÃO USADO:
                ...
                <tr><td>VALOR USADO AVALIAÇÃO:</td>
                    <td><asp:TextBox ID="txtVlAvaliacao2" CssClass="form-contrato" runat="server" Height="16px"></asp:TextBox></td>
                    <td>Quitação:</td>
                    <td colspan="2"><asp:TextBox ID="txtVlQuitacao2" CssClass="form-contrato" runat="server" Height="16px"></asp:TextBox></td>
                    <td >Saldo da Avaliação:</td>
                    <td colspan="2"><asp:TextBox ID="txtSaldoAvaliacao2" CssClass="form-contrato" runat="server" Height="16px"></asp:TextBox></td>                
                ...
                <tr>
                    <td><span style="font-size:11px; ">1) Autorizo a Dragon Motors a faturar em meu nome e CPF o (s) veiculo (s) objeto do presente contrato nas condições de preço e forma de pagamento acima descrito.<br />
                     ...
                     <asp:Label ID="lblPlaca2"  CssClass="form-contrato" runat="server" Text=""></asp:Label>
                        , conforme negociação descrita no contrato de compra e venda sob pena de não ser concretizada, nos termos, condições e benefícios negociados na compra.<br />
                        7) O IPVA 2020 será isento desde que o cliente atenda as regras da Lei Distrital Nº 4.733/2011. Essa condição não contempla Seg. Obrigatório 2020;<br />
                        8) Estou ciente que a contratação do serviço de emplacamento e despachante oferecido pela Dragon Motors é opcional, e que esse serviço poderá ser feito diretamente junto ao Detran/DF.
                        </span>
                    </td>
                </tr>
            </table>
            ...
            <table border="1" cellspacing="0" style="width: 18.2cm;">
                ...
                <tr>
                    ...
                    <td colspan="5">
                        <asp:TextBox ID="txtFormasPagamento3" CssClass="form-contrato" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>AVALIAÇÃO USADO:
                ...
                <tr><td>VALOR USADO AVALIAÇÃO:</td>
                    <td><asp:TextBox ID="txtVlAvaliacao3" CssClass="form-contrato" runat="server" Height="16px"></asp:TextBox></td>
                    <td>Quitação:</td>
                    <td colspan="2"><asp:TextBox ID="txtVlQuitacao3" CssClass="form-contrato" runat="server" Height="16px"></asp:TextBox></td>
                    <td >Saldo da Avaliação:</td>
                    <td colspan="2"><asp:TextBox ID="txtSaldoAvaliacao3" CssClass="form-contrato" runat="server" Height="16px"></asp:TextBox></td>                
                ...
                <tr>
                    <td><span style="font-size:11px; ">1) Autorizo a Dragon Motors a faturar em meu nome e CPF o (s) veiculo (s) objeto do presente contrato nas condições de preço e forma de pagamento acima descrito.<br />
                     ...
                     <asp:Label ID="lblPlaca3" CssClass="form-contrato" runat="server" Text=""></asp:Label>
                        , conforme negociação descrita no contrato de compra e venda sob pena de não ser concretizada, nos termos, condições e benefícios negociados na compra.<br />
                        7) O IPVA 2018 será isento desde que o cliente atenda as regras da Lei Distrital Nº 4.733/2011. Essa condição não contempla Seg. Obrigatório 2018;<br />
                        8) Estou ciente que a contratação do serviço de emplacamento e despachante oferecido pela Dragon Motors é opcional,e que esse serviço poderá ser feito diretamente junto ao Detran/DF.
                        </span>
                    </td>
                </tr>
...
&nbsp;&nbsp;&nbsp;
        ...
        <asp:Panel ID="Panel1" runat="server" Width="100%" Height="100%">
            ...
            <br /><br />
            <br />
             <img src="../img/contratodragon.png" style="width: 20cm;" />
            <br />
            ...
            CHASSI/PLACA:<asp:Label ID="lblDeclaracaoChassiPlaca" CssClass="form-aviso" runat="server" Text="Label"></asp:Label>  
                &nbsp;a concessionária Dragon Motors atentendo as disposições previstas na Lei nº 13.111/15 me informou previamente:<br /><br />
