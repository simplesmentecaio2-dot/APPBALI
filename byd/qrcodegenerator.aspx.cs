...
public partial class veiculos_contrato : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        QRCodeGenerator.QRCode qrcode = qrGenerator.CreateQrCode("https://app.bali.com.br/byd/confirmafluxo.aspx?id=" + HttpUtility.UrlEncode(code), QRCodeGenerator.ECCLevel.Q);
