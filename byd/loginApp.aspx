<%@ Page Language="C#" AutoEventWireup="true" CodeFile="loginApp.aspx.cs" Inherits="login" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Login | Prospecção BALI Motors</title>
    <meta charset="UTF-8" />
    ...
    <link rel="stylesheet" type="text/css" href="../css/bali-login.css?v=20260624-bg3" />
    <!--===============================================================================================-->
</head>
    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form class="login100-form validate-form p-b-33 p-t-5 wrap-input100" runat="server">
                    ...
                    <a class="password-change-link" href="/alterarSenha.aspx?voltar=/byd/loginApp.aspx">Alterar senha</a>
