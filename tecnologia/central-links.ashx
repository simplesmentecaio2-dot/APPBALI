<%@ WebHandler Language="C#" Class="TecnologiaCentralLinksHandler" %>
...
public class TecnologiaCentralLinksHandler : IHttpHandler
{
    ...
    {
        return context.Server.MapPath("~/tecnologia/central-links.json");
    }
