...
public partial class ramais_login : System.Web.UI.Page
{
    ...
    protected void btnLogin_Click(object sender, EventArgs e)
    {
        ...
        {
            MostrarMensagem("Informe usuario e senha para acessar os Ramais.");
            txtUsuario.Focus();
            return;
        }
        ...
        try
        {
            ...
            if (usuario != "N")
            {
                ...
                RegistrarAuditoriaLoginRamais("LOGIN_RAMAIS", "Login realizado com sucesso.");
                RedirecionarVolta();
                return;
            }
        }
        ...
        txtUsuario.Value = "";
        txtSenha.Value = "";
        RegistrarAuditoriaLoginRamais("LOGIN_INVALIDO_RAMAIS", "Tentativa invalida para usuario informado: " + usuarioInformado, usuarioInformado);
    ...
    private bool UrlLocalSegura(string url)
    {
        ...
        return url.StartsWith("default.aspx", StringComparison.OrdinalIgnoreCase)
            || url.StartsWith("logs.aspx", StringComparison.OrdinalIgnoreCase)
            || url.StartsWith("/RAMAIS/", StringComparison.OrdinalIgnoreCase);
    }
    ...
    private void RegistrarAuditoriaLoginRamais(string acao, string detalhe, string usuarioTentativa = "")
    {
        try
        {
