...
public partial class veiculos_contrato : System.Web.UI.Page
{
          ...
          return;
            ...
            try
            {
                ...
                if (String.Equals(obs, "S", StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    if (tipo == "VN")
                    {
                        Response.Redirect("Print-ContratoVNJEEP.aspx?contrato=" + contratoUrl);
                    }
                    if (tipo == "VU")
                    {
                        Response.Redirect("Print-ContratoVUJEEP.aspx?contrato=" + contratoUrl);
                    }
                }
  ...
  protected void Button1_Click(object sender, EventArgs e)
  {
      ...
      try
      {
          select_Tab_ConsultaPeriodo("Print-ContratoVNJEEP.aspx", "VN", dtInicio, dtFim, out tabelaR);
      }
      catch (Exception ex)
      {
  ...
  protected void Button2_Click(object sender, EventArgs e)
  {
      ...
      try
      {
          select_Tab_ConsultaPeriodo("Print-ContratoVUJEEP.aspx", "VU", dtInicio, dtFim, out tabelaVUR);
      }
      catch (Exception ex)
      {
