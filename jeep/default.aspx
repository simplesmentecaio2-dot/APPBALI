...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetConviteQrCode(id) {
            ...
            $.ajax({
                method: "post",
                url: 'prospeccao.aspx/GetConviteQrCodePo',
                data: '{id: ' + id + '}',
    ...
    <form id="form1" class="needs-validation" runat="server" novalidate="novalidate">
            ...
            <div class="app-header header-shadow">
                ...
                <div class="app-header__content">
                    <div class="app-header-left">
                        <div class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" style="display: none;" aria-hidden="true">
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    <asp:UpdatePanel runat="server" ID="alterarSenha">
                                        <ContentTemplate>
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-key mr-2"></i>Alterar senha</h5>
                                            ...
                                            <div class="modal-body">
                                                <div class="position-relative row form-group">
                                                    <label for="examplePassword" class="col-sm-12 col-form-label">Senha</label>
                                                    <div class="col-sm-12">
                                                        <input name="password" runat="server" id="txtSenhaAtual" placeholder="Senha atual" type="password" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="position-relative row form-group">
                                                    <label for="examplePassword" class="col-sm-12 col-form-label">Nova senha</label>
                                                    <div class="col-sm-12">
                                                        <input name="password" runat="server" id="txtNovaSenha" placeholder="Nova senha" type="password" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="position-relative row form-group">
                                                    <label for="examplePassword" class="col-sm-12 col-form-label">Confirmação</label>
                                                    <div class="col-sm-12">
                                                        <input name="password" runat="server" id="txtConfirmaNovaSenha" placeholder="Confirme nova senha" type="password" class="form-control"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-danger" data-dismiss="modal">Fechar</button>
                                                <asp:Button runat="server" ID="btnSalvarSenha" 
                                                                CssClass="btn btn-primary" OnClick="updatePassword" Text="Alterar"/>
                                            </div>

                                            <asp:UpdateProgress ID="UpdateProgress3"
                                                runat="server"
                                                AssociatedUpdatePanelID="alterarSenha"
                                                DisplayAfter="50">
                                                <ProgressTemplate>
                        ...
                        <a href="javascript:void(0);" class="nav-link" data-toggle="modal" data-target=".bd-example-modal-sm">
                            ...
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    ...
                                    <div class="widget-content-left">
                                        <div class="btn-group ">
                                            <asp:LinkButton runat="server" ID="sair" 
                                                            CssClass="text-danger mt-1 h5" 
                                                            OnClick="btnSair_Click" Text="sair"></asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    ...
                                    <a href="./dashboard_acompanhamento.aspx">
                    ...
                    <div class="app-main__inner">
                        ...
                        <div class="tab-content mb-5">
                                                ...
                                                <asp:UpdatePanel ID="upDescarte" runat="server">
                                                    <ContentTemplate>
                                                        ...
                                                        <div class=" mb-3">
                                                            ...
                                                            <select id="ddlEquipeConviteDescarte" runat="server" class="custom-select text-uppercase" required="required"
                                                                datasourceid="SqlDataSource2"
                                                                datatextfield="equipe" datavaluefield="equipe">
                                                            </select>
                                                        </div>
                                                        <div class=" mb-3">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-row">
                                                                        ...
                                                                        <div class="col-md-4 mb-3">
                                                                            ...
                                                                            <select id="ddlequipe" runat="server" name="ddlequipe"
                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            ...
                                                            <asp:SqlDataSource ID="SqlDataSource6" runat="server" 
                                                                ConnectionString="<%$ ConnectionStrings:APPConnectionString %>" 
                                                                SelectCommand="SELECT loja,equipe,count(*) as qtde FROM [APP].[dbo].[veiculos_prospeccao]  where nome_evento = 'Lapis Vermelho' group by loja,equipe  order by loja desc"></asp:SqlDataSource>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="tab-pane tabs-animation fade show" id="tab-content-2" role="tabpanel">
                                ...
                                <div class="modal fade mt-5" id="qrcode" tabindex="-1" role="dialog" 
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" onclick="DownloadAsImageQr()" class="btn btn-success">
                                            ...
                                            <div class="col-md-12">
                                                <div class="main-card mb-3 card">
                                                    <div class="card-header-tab card-header-tab-animation card-header mb-3">
                                                        <div class="card-header-title">
                                                            <i class="header-icon lnr-apartment icon-gradient bg-love-kiss"></i>
                                                            <select id="ddlEventoProcessarQrCode" runat="server" name="ddlEvento2" class="form-control"
                                                                required="required" datasourceid="SqlDataSource2"
                                                                datatextfield="nome" datavaluefield="nome">
                                                            </select>
                                                            <asp:LinkButton ID="Button3"
                                                                CssClass="btn btn-success m-3"
                                                                runat="server"
                                                                OnClick="btnProcessarQrCode">
                                ...
                                <div class="row">
                                                ...
                                                <asp:UpdatePanel ID="upFluxo" runat="server">
                                                    <ContentTemplate>
                                                        ...
                                                        <button class="mb-2 mr-2 col-4 btn btn-dark text-right font-size-lg">
                                                            ...
                                                            <asp:Label ID="lblPercConfirmado" CssClass="ml-2 badge badge-light col-md-4"
                                                                runat="server" Text="0%" data-toggle="tooltip" data-placement="top"
                                                                title="(Confirmados * 100)/Total Realizados"></asp:Label>
                                                        </button>
                                                        <br />
                                                        ...
                                                        <button class="mb-2 mr-2 col-4 btn btn-dark text-right  font-size-lg">
                                                            ...
                                                            <asp:Label ID="lblPercQuentes" CssClass="ml-2 badge badge-light col-md-4"
                                                                runat="server" Text="0%" data-toggle="tooltip" data-placement="top"
                                                                title="(Quentes * 100)/Total Realizados"></asp:Label>
                                                        </button>
                                                        <br />
                                                        ...
                                                        <button class="mb-2 mr-2 col-4 btn btn-dark text-right font-size-lg">
                                                            ...
                                                            <asp:Label ID="lblPercFrios" CssClass="ml-2 badge badge-light col-md-4"
                                                                runat="server" Text="0%" data-toggle="tooltip" data-placement="top"
                                                                title="(Frios * 100)/Total Realizados"></asp:Label>
                                                        </button>
                                                        <br />
                                                        <button class="mb-2 mr-2 col-7  btn btn-alternate font-size-lg">Sem Interesse:</button>
                                                        <button class="mb-2 mr-2 col-4 btn btn-dark text-right  font-size-lg">
                                                            <asp:Label ID="lblseminteresse" runat="server" Text="0"></asp:Label>
                                                            <asp:Label ID="lblPercSemInteresse" CssClass="ml-2 badge badge-light col-md-4"
                                                                runat="server" Text="0%" data-toggle="tooltip" data-placement="top"
                                                                title="(Sem Interesse * 100)/Total Realizados"></asp:Label>
                                                        </button>
                                                        <br />
                                                        <button class="mb-2 mr-2 col-7 btn btn-primary  font-size-lg">
                                                            Descarte:</button>
                                                        <button class="mb-2 mr-2 col-4 btn btn-dark text-right  font-size-lg">
                                                            ...
                                                            <asp:Label ID="lblPercDescarte" CssClass="ml-2 badge badge-light col-md-4"
                                                                runat="server" Text="0%" data-toggle="tooltip" data-placement="top"
                                                                title="(Descartes * 100)/Total Realizados"></asp:Label>
                                                        </button>
                                                        <br />
                                                        ...
                                                        <br />
                                                        <button class="mb-2 mr-2 col-7  btn btn-secondary font-size-lg">
                                                            Projeção de Venda de Veículo:
                                                        </button>
                                                        <button class="mb-2 mr-2 col-4 btn btn-dark text-right  font-size-lg">
                                    ...
                                    <!-- <div class="col-md-4">
                                        <div class="main-card mb-3 card">
                                            ...
                                            <div class="container-fluid mb-3 ">
                                                <button class="mb-2 mr-2 btn btn-primary font-size-lg mb-2">SIA<span class="badge badge-light font-size-lg">92</span></button>
                                                <button class="mb-2 mr-2 btn btn-danger font-size-lg mb-2">SAAN<span class="badge badge-light font-size-lg">36</span></button>
                                                <button class="mb-2 mr-2 btn btn-success font-size-lg mb-2">SCIA<span class="badge badge-light font-size-lg">32</span></button>
                                            </div>
                                        </div>
                                    </div>-->
                                    <div class="col-md-4">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer mb-5">
                                                            ...
                                                            <button type="button" onclick="DownloadAsImage()" class="btn btn-success">
                                                                <i class="fas fa-file-download fa-2x"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                <ContentTemplate>
                                                    <div id="campoLead" class="container mr-n3" runat="server">
                                                        <div class="container-fluid mb-3 ">
                                                            <ul class="list-group">
                                                                <label id="campoNomeLead" runat="server" 
                                                                    class="row active list-group-item-action list-group-item text-uppercase mb-1">
                                                                ...
                                                                <label id="contador" runat="server" 
                                                                    class="row list-group-item-action list-group-item text-uppercase mb-1">
                                                                    <b class="mb-3">
                                                                ...
                                                                <div id="campoTelefoneLead1" runat="server" class="row">
                                                                    <div class="col-12 row mb-1">
                                                                        ...
                                                                        <asp:LinkButton ID="btnWhats" runat="server" 
                                                                            CssClass="btn-success col-2 text-center p-0 m-0" 
                                                                            OnClick="btnWhats_Click">
                                                                ...
                                                                <div id="campoTelefoneLead2" runat="server" class="row">
                                                                    <div class="col-12 row mb-1">
                                                                        ...
                                                                        <asp:LinkButton ID="btnWhats2" runat="server" 
                                                                            CssClass="btn-success col-2 text-center p-0 m-0" 
                                                                            OnClick="btnWhats_Click2">
                                                                            <i class="fab fa-whatsapp fa-2x text-light m-3"></i>
                                                                        </asp:LinkButton>
                                                                ...
                                                                <div id="campoTelefoneLead3" runat="server" class="row">
                                                                    <div class="col-12 row mb-1">
                                                                        ...
                                                                        <asp:LinkButton ID="btnWhats3" runat="server" 
                                                                            CssClass="btn-success col-2 text-center p-0 m-0" 
                                                                            OnClick="btnWhats_Click3">
                                                                            <i class="fab fa-whatsapp fa-2x text-light m-3"></i>
                                                                        </asp:LinkButton>
                                                                ...
                                                                <label class="list-group-item-action list-group-item text-uppercase row">
                                                                    <i class="fas fa-info-circle mr-1 fa-2x"></i>
                                                                    <b class="mb-3">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-7 col-sm-7">
                                                                            <select class="custom-select text-uppercase"
                                                                                ...
                                                                                <option value="NÃO QUER SER INCOMODADO"></option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                </label>
                                                                ...
                                                                <label class="list-group-item-action list-group-item text-uppercase row">
                                                                    <div id="divEquipeLead" runat="server">
                                                                        <div class="row">
                                                                            <div class="col-md-5 col-sm-5">
                                                                                <div class="input-group-prepend">
                                                                            ...
                                                                            <div class="col-md-7 col-sm-7">
                                                                                <select runat="server"
                                                                                    id="ddlEquipeLead" class="custom-select text-uppercase" required="required"
                                                                                    datasourceid="SqlDataSource2"
                                                                                    datatextfield="equipe" datavaluefield="equipe">
                                                                                </select>
                                                                            </div>
                                                        ...
                                                        <div class="card-footer">
                                                            <div class="col-12 text-center ml-n3">
                                                                <asp:LinkButton ID="btnSalvarLead" runat="server"
                                                                    OnClick="btnSalvarLead_Click" CssClass="btn btn-lg btn-success  mr-2 "
                                                                    data-toggle="tooltip" data-placement="top" title="Confirmado">
                                                                    <i class="fas fa-thumbs-up fa-2x"></i>

                                                                </asp:LinkButton>
                                                                <asp:LinkButton ID="btnDescartarLead" runat="server"
                                                                    OnClick="btnDescartaLead_Click" CssClass="btn btn-lg btn-warning mr-2"
                                                                    data-toggle="tooltip" data-placement="top" title="À confirmar">
                                                                    <i class="fas fa-retweet fa-2x"></i>

                                                                </asp:LinkButton>
                                                                <asp:LinkButton ID="btnDescartarLeadLixo" runat="server"
                                                                    OnClick="btnDescartaLeadLixo_Click" CssClass="btn btn-lg btn-danger mr-2"
                                                                    data-toggle="tooltip" data-placement="top" title="Descartar">
                                                    ...
                                                    <div class="container">
                                                        <div runat="server" id="no_logado" visible="false">
                                                            <div class='alert alert-danger fade show' role='alert'>
                                                                ...
                                                                <a href="../Login.aspx">
                                                                    <link id='Button1' runat='server'
                                                                        class='offset-4 mr-2 '>login <i class="fas fa-sign-out-alt"></i></link>
                                                                </a>
                                                            </div>
                                                        </div>
                                                        <div runat="server" id="no_lead" visible="false">
                                                            ...
                                                            <asp:LinkButton runat="server" ID="LinkButton1" 
                                                                OnClick="btnAtualizaLead_Click"><i class="fas fa-sync-alt"></i></asp:LinkButton>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="modal fade mt-5" id="myModal" role="dialog">
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div id="conviteQrCodeLead" style="letter-spacing: 1px;"
                                                                    class="modal-body text-center">
                                                                    <div class="badge badge-light">
                                                                        <div class="text-center">
                                                                            <b>
                                                                                <label id="txtClienteQrLead" runat="server" 
                                                                        ...
                                                                        <div class="text-center">
                                                                            <label id="txtEventoQrLead" runat="server" 
                                                                                class="badge badge-secondary font-size-lg"></label>
                                                                        </div>
                                                                        <div class="text-center">
                                                                            <label id="txtDataQrLead" runat="server" 
                                                                                class="badge badge-secondary font-size-lg"></label>
                                                                        </div>
                                                                        <br />
                                                                        <div class="text-center">
                                                                ...
                                                                <div class="modal-footer mb-5">
                                                                    ...
                                                                    <button id="printConviteLead" type="button" 
                                                                        class="btn btn-primary" visible="false"><i class="fas fa-print fa-2x"></i></button>
                                                                    <button type="button" onclick="DownloadAsImage()" 
                                                                        class="btn btn-success"><i class="fas fa-file-download fa-2x"></i></button>
                                                                    <script 
                                                                        src="https://rawgit.com/dabeng/OrgChart/master/demo/js/jspdf.min.js"></script>
                                                                    <script>
                                                                        'use strict';
                                                            ...
                                                            <div class="card mb-3 widget-content bg-animation bg-danger">
                                                                <div class="widget-content-wrapper text-white">
                                                                    ...
                                                                    <div class="widget-content-right">
                                                                        <div class="widget-numbers text-white"><span id="txtQtdePendentes" 
                                                        ...
                                                        <div class="col-md-12 col-xl-12">
                                                            <div class="card mb-3 widget-content bg-primary">
                                                                <div class="widget-content-wrapper text-white">
                                                                    ...
                                                                    <div class="widget-content-right">
                                                                        <div class="widget-numbers text-white"><span id="txtQtdeRealizados" 
                                                                            runat="server"></span></div>
                                                                    </div>
                                                                </div>
                                                            </div>
        ...
        <footer class="fixed-bottom bg-white">
            <div class="container text-center mb-2 mt-2">
                <b>&copy;TECNOLOGIA</b> | <img src="assets/images/logo.png"/>
            </div>
