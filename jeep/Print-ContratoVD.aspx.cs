...
public partial class veiculos_Pint_Contrato : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ContratoAuditoria.Registrar("Jeep", "VD", contrato, Convert.ToString(Session["id"] ?? ""), Convert.ToString(Session["usuario"] ?? ""), Request.UserHostAddress ?? "", Request.RawUrl ?? "", "IMPRIMIR_CONTRATO", "Contrato=" + contrato + "; Tipo=VD; Marca=Jeep; Pagina=Print-ContratoVD.aspx", "", "");
        ...
        {
            ContratoImpressao.RegistrarErro(this, "Jeep", "VD", contrato, ex);
            ContratoImpressao.ExibirContratoNaoLocalizado(this, "./contrato.aspx");
            return;
        }
