<%@ Page Language="C#" AutoEventWireup="true" CodeFile="telfinanceiras.aspx.cs" Inherits="veiculos_Recibo_desconto" %>
...
<head runat="server">
    <title>Telefones das Financeiras Jeep - Bali</title>
        ...
        <div>
            ...
            <div id="menu">
                ...
                <div style="text-align: right; margin-right: 15px;">
                    <asp:Label ID="lblFrmID" runat="server" Text="Telefones das Financeiras Jeep"></asp:Label>
                </div>
            </div>
