<%@ Page Language="C#" AutoEventWireup="true" CodeFile="contratodragon.aspx.cs" Inherits="veiculos_contrato" %>
...
<body>
    <form id="form1" style="height: 100%;" runat="server">
        ...
        <div id="topo">
            <table id="table-menu">
                <tr>
                    <td id="table-menu-logo"><font style="font-family: Arial black; font-size: 32px; font-style: italic; color: white; margin-left: 13px;"><a href="../Default.aspx" class="linkHome">DRAGON PREMIUM</a></font><font style="font-family: Calibri; font-size: 14px; margin-left: 5px; font-style: italic; color: white;">APP</font><%--<img src="img/logo4.png" style="margin-left:13px; margin-top:-10px; height: 78px; width: 161px;" />--%></td>
            ...
            <table style="width: 100%; padding: 13px; text-align: left;" align="center">
                <tr style="width: 100%;">
                    <td style="width: 100%;">
                        ...
                        <asp:TabContainer ID="TabContainerProcesso" CssClass="tabPanelConsultar" Width="100%" runat="server" ActiveTabIndex="3">
 ...
 <asp:TabPanel ID="TabPanel3" Style="padding: 20px;" runat="server" HeaderText="TabPanel1" visible="false">
                                <HeaderTemplate>
                                    Editar Contrato
                                </HeaderTemplate>
                                <ContentTemplate>
                                    ...
                                    <br /><br />
                                    <%--<asp:RadioButton ID="rbtnEdNovo" GroupName="tipo" Text="NOVO" runat="server" AutoPostBack="True" OnCheckedChanged="rbtnVN_CheckedChanged" />&nbsp&nbsp&nbsp
                                    <asp:RadioButton ID="rbtnEdUsado" GroupName="tipo" Text="USADO" runat="server" AutoPostBack="True" OnCheckedChanged="rbtnVU_CheckedChanged" />--%>
