<%@ Page Language="C#" AutoEventWireup="true" CodeFile="consultar_avaliacao.aspx.cs" Inherits="veiculos_contrato" %>
                             ...
                             <ul class="vertical-nav-menu">
                                ...
                                <li class="app-sidebar__heading">__________________________________</li>
                                 <li>
                                    ...
                                    <a href="./consultar_avaliacao.aspx" class="mm-active">
                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6 mb-3">
                                                        <script type="text/javascript">
                                                            $("#txtPlaca").mask("AAA-AAAA");
                                                        </script>
                                                        <label for="txtPlaca" class="text-uppercase ml-2"><strong>Placa</strong></label>
                                                        <input type="text" id="txtPlaca" class="form-control" runat="server" placeholder="Placa..." required="true">
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label for="txtValor" class="text-uppercase ml-2"><strong>Valor</strong></label>
                                                        <input type="text" id="txtValor" class="form-control" runat="server" placeholder="Valor..." required="true">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-footer">
                                                <div class="col-12">
                                                    <asp:LinkButton ID="btnBuscar" runat="server" CssClass="btn btn-lg btn-success col-6 offset-3" OnClick="btnBuscarAvaliacao">Buscar</asp:LinkButton>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
