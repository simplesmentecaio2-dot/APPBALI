<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print-ContratoVNJEEP.aspx.cs" Inherits="veiculos_Pint_Contrato" %>
...
<head runat="server">
    ...
    <link href="../css/bali-print-contract.css?v=20260712-contratorodape01" rel="stylesheet" />
    <script src="../js/bali-print-contract.js?v=20260712-contratorodape01"></script>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="pnlImpressao" runat="server" Visible="true" Style="font-family: Arial; font-size: 9px; margin-top: 34px;" Width="100%" Height="50%">
            ...
            <table border="1" cellspacing="0" style="width: 18.2cm;">
                ...
                <tr>
                    <td><span style="font-size:11px; ">1) Autorizo a Bali Motors a faturar, em meu nome e CPF/CNPJ, o(s) veículo(s) objeto deste contrato, conforme preço e forma de pagamento acima descritos.<br />
                        ...
                        4) Os preços, itens de série e condições da tabela GAMA JEEP poderão ser alterados conforme tabela vigente na data de faturamento do(s) veículo(s).<br />
...
&nbsp;&nbsp;&nbsp;
        ...
        <asp:Panel ID="Panel1" runat="server" Width="100%" Height="100%">
            ...
            <table border="1" cellspacing="0" style="width: 18.2cm;">
                ...
                <tr>
                    <td colspan="5" class="auto-style4">ÓRGÃO EXPEDIDOR: SSP-DF</td>
