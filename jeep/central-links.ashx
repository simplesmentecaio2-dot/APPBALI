<%@ WebHandler Language="C#" Class="JeepCentralLinksHandler" %>
...
public class JeepCentralLinksHandler : IHttpHandler
{
    ...
    {
        return context.Server.MapPath("~/jeep/central-links.json");
    }
