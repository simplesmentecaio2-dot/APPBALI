<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Print-ContratoVUJEEP.aspx.cs" Inherits="veiculos_Pint_Contrato" %>
            ...
            <div style="width: 19cm; border: 1px solid black; font-family: 'Times New Roman'; padding: 20px;" id="Div1">
                ...
                <table border="0" cellspacing="0" style="width: 18.2cm;">
                    <caption>
                        <tr>
                            <td>
                                <img src="../img/header-contratoJEEP.png" style="width: 18cm;" />
                ...
                <table border="1" cellspacing="0" style="width: 18.2cm;">
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            <asp:TextBox ID="txtFormasPagamento" CssClass="form-contrato" runat="server" Enabled="False"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>AVALIAÇÃO USADO:
                ...
                <table border="1" cellspacing="0" style="width: 18.2cm;">
                    ...
                    <tr>
                        <td><span style="font-size: 11px;">1) Autorizo a BALI MOTORS a faturar em meu nome e CPF o (s) veiculo (s) objeto do presente contrato nas condições de preço e forma de pagamento acima descrito.<br />
                ...
                <table border="1" cellspacing="0" style="width: 18.2cm;">
                    ...
                    <tr>
                     ...
                     <asp:Label ID="lblDiaPromissoria" runat="server" CssClass="form-contrato" Text="Label"></asp:Label>
                            pagarei por esta única via de Nota Promissória a Bali Motors LTDA CNPJ 36.444.055/0001-38 ou à sua ordem, a quantia de
            ...
            <div style="width: 19cm; border: 1px solid black; font-family: 'Times New Roman'; padding: 20px;" id="Div2">
                ...
                <table border="1" cellspacing="0" style="width: 18.2cm;">
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            <asp:TextBox ID="txtFormasPagamento2" CssClass="form-contrato" runat="server" Enabled="False"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>AVALIAÇÃO USADO:
            ...
            <div style="width: 19cm; border: 1px solid black; font-family: 'Times New Roman'; padding: 20px;" id="Div3">
                ...
                <table border="1" cellspacing="0" style="width: 18.2cm;">
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            <asp:TextBox ID="txtFormasPagamento3" CssClass="form-contrato" runat="server" Enabled="False"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>AVALIAÇÃO USADO:
 ...
 indevido, imperícias, negligências e abuso do veículo, após  ter sido retirado da Concessionária.
        ...
        <asp:Panel ID="Panel1" runat="server" Width="100%" Height="100%">
            ...
            <table border="1" cellspacing="0" style="width: 18.2cm;">
                ...
                <tr>
                    <td colspan="5" class="auto-style4">ORGÃO EXPEDIDOR: SSP-DF</td>
           ...
           <%-- <img src="../img/header-contratoJEEP.png" style="width: 20cm;" />--%>
          ...
          <%--  <span style="font-size: 17px;">
                ...
                <asp:Label ID="lblDeclaracaoCarro" runat="server" CssClass="form-aviso" Text="Label"></asp:Label><br />
                    ...
                    &nbsp;a concessionária Bali Motors Ltda, atentendo as disposições previstas na Lei nº 13.111/15 me informou previamente:<br />
                    <br />
...
<asp:Panel ID="guiadocomprador" runat="server" Width="100%" Height="100%" visible="false" >
            ...
            <br />
                    <span style="font-size: 17px;">
                    <img src="../img/GUIDADOCOMPRADORJEEP.PNG" style="height: 695px; width: 628px;" />
                    </span>
