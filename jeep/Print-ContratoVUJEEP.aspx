...
<head runat="server">
    ...
    <link href="../css/bali-print-contract.css?v=20260625-backbutton" rel="stylesheet" />
    <script src="../js/bali-print-contract.js?v=20260625-backbutton"></script>
            ...
            <div style="width: 19cm; border: 1px solid black; font-family: 'Times New Roman'; padding: 20px;" id="Div2">
                ...
                <table border="1" cellspacing="0" style="width: 18.2cm;">
                    ...
                    <tr>
                        ...
                        <td colspan="8">
                            <asp:TextBox ID="txtCortesias2" CssClass="form-contrato contrato-texto-justificado" TextMode="MultiLine" Rows="2" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>OBS:
