<%@ Page Language="C#" AutoEventWireup="true" CodeFile="contasjeep.aspx.cs" Inherits="veiculos_Recibo_desconto" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div id="topo">
                <table id="table-menu">
                    <tr>
                        <td id="table-menu-logo"><font id="logo" style="font-family: Arial black; font-size: 32px; font-style: italic; color: white; margin-left: 13px;"><a href="/principal.aspx" class="linkHome"><img src="../img/logojeep.png" style="height: 36px; width: 141px" /></a></font><font style="font-family: Calibri; font-size: 14px; margin-left: 5px; font-style: italic; color: white;">APP</font><%--<img src="img/logo4.png" style="margin-left:13px; margin-top:-10px; height: 78px; width: 161px;" />--%></td>
...
<fieldset><legend>Contas Jeep</legend><br />
                            <img src="../img/imprimir.png" style="width: 30px; cursor: pointer;" onclick="javascript: imprimePanel()" /> <asp:Panel ID="pnlImpressao" runat="server" Width="100%" Height="100%"><style>
                                ...
                                <div style="width: 19cm; border: 1px solid black; font-family: 'Times New Roman'; padding: 20px;" id="recibo"><div style="text-align: center; height: 108px;"><img src="../img/header-contratoJEEP.png" style="height: 44px; width: 712px" /></div>
								<br /><div style="text-align: center; font-size: large; height: 654px;">
