<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dashboard_resultado.aspx.cs" Inherits="veiculos_contrato" %>
...
<body>
    <form id="form1" class="needs-validation" runat="server" novalidate="novalidate">
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:APPConnectionString %>" SelectCommand="prospeccao_evento_todos_po" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    ...
                                    <a href="./dashboard_resultado.aspx" class="mm-active">
                                    ...
                                    <div class="page-title-wrapper">
                                        <div class="page-title-heading">
                                            <div class="page-title-icon">
                                                <i class="fas fa-chalkboard icon-gradient bg-dark"></i>
                                            </div>
                                            <div>
                                                <b>Dashboard Resultado</b>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-xl-3">
                                        <div class="card mb-3 widget-content bg-grow-early">
                                            <div class="widget-content-wrapper text-white">
                                                <div class="widget-content-left">
                                                    <div class="widget-heading">Fluxo por Convites</div>
                                                    <div class="widget-subheading">Total de Fluxo por convite.</div>
                                                </div>
                                                <div class="widget-content-right">
                                                    <div class="widget-numbers text-white">
                                                        <span>
                                                            <asp:Literal ID="txtTotalFluxoConvites" runat="server"></asp:Literal></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-3 col-xl-3">
                                        <div class="card mb-3 widget-content bg-info">
                                            <div class="widget-content-wrapper text-white">
                                                <div class="widget-content-left">
                                                    <div class="widget-heading">Fluxo de Passantes</div>
                                                    <div class="widget-subheading">Total de clientes passantes.</div>
                                                </div>
                                                <div class="widget-content-right">
                                                    <div class="widget-numbers text-white">
                                                        <span>
                                                            <asp:Literal ID="txtTotalPassantes" runat="server"></asp:Literal></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card mb-3 widget-content " style="background-color: red;">
                                            <div class="widget-content-wrapper text-white">
                                                <div class="widget-content-right">
                                                    <div class="widget-numbers text-white">
                                                        <span>
                                                            <asp:Literal ID="literalVermelha" runat="server"></asp:Literal>
                                                        </span><span class="h6">Vendas</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
