<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Autorizacao_polimentoJEEP.aspx.cs" Inherits="jeep_Autorizacao_polimento" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta charset="utf-8" />
    <title>Autorização de Polimento - Jeep</title>
            ...
            <table id="table-menu">
                <tr>
                    ...
                    <td id="table-menu-usuario" class="idUser">Usuário:
                        ...
                        C&oacute;digo:
                        <asp:Label ID="lblTipo" CssClass="idUser" runat="server" Style="margin-right: 13px;"></asp:Label><a class="bali-logout-link" href="/logout.aspx?voltar=/jeep/loginAppcontrato.aspx">Sair</a></td>
                </tr>
            </table>
        </div>
                ...
                <asp:Panel ID="pnlImpressao" runat="server" Width="100%" Height="100%">
                    <div style="width: 18.6cm; min-height: 0; height: 25.7cm; box-sizing: border-box; border: 1px solid #111; font-family: 'Times New Roman', serif; padding: .65cm; color: #111; background: #fff; overflow: hidden;" id="autorizacao-polimento">
                        ...
                        <div style="border: 1px solid #222; background: #f7f7f7; padding: 6px 10px; margin: 0 0 10px; text-align: center; text-transform: uppercase;">
                            ...
                            <strong style="display: block; font-size: 14px; line-height: 1.15;">Autoriza&ccedil;&atilde;o de venda</strong>
                            <span style="display: block; font-size: 10px; text-transform: none;">Gerada a partir do pedido e da loja informados.</span>
                        </div>
