<%@ Page Language="C#" AutoEventWireup="true" CodeFile="biWF.aspx.cs" Inherits="veiculos_contrato" %>
        ...
        <main class="bi-frame-shell">
            <section class="bi-frame-header">
                <div>
                    ...
                    <p>Painel de workflow incorporado do Power BI, com iframe responsivo e sem scripts externos desnecessários.</p>
                </div>
