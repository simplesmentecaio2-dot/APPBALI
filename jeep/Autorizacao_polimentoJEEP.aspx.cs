...
public partial class jeep_Autorizacao_polimento : System.Web.UI.Page
{
    private const string MarcaPolimento = "Jeep";
    private const string EmpresaDocumento = "BALI MOTORS LTDA";
...
GROUP BY
    ...
    private string TipoPolimentoSelecionado()
    {
        ...
        string tipoBusca = tipo.ToUpperInvariant();
