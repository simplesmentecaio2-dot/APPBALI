<%@ Page Language="C#" AutoEventWireup="true" CodeFile="criar_fluxo.aspx.cs" Inherits="veiculos_contrato" %>
                        ...
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    ...
                                    <a href="./criar_fluxo.aspx" class="mm-active">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3 card">
                                            ...
                                            <div class="card-body bg-light">
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <label for="txtTelefone" class="text-uppercase ml-2"><strong>Telefone</strong></label>
                                                        <input type="text" id="txtTelefone" class="form-control" runat="server" placeholder="Telefone..." required="true">
                                                    </div>
                                                    <div class="col-md-6 mb-3">
                                                        <label for="ddl" class="text-uppercase ml-2"><strong>Loja</strong></label>
                                                        <select id="ddlLoja" runat="server" class="form-control" required="required">
                                                            <option>SIA</option>
                                                            <option>SCIA</option>
                                                            <option>SAAN</option>
                                                        </select>
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        <label for="ddl" class="text-uppercase ml-2"><strong>Evento</strong></label>
                                            ...
                                            <div class="card-footer">
                                                <div class="col-12">
                                                    <asp:LinkButton ID="btnSalvarPassante" runat="server" CssClass="btn btn-lg btn-success col-6 offset-3" OnClick="btnSalvarPassante_Click">SALVAR</asp:LinkButton>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="text-center col-12"><span class="badge badge-primary col-12">Ultimo cliente cadastrado</span></div>
                                        <div class="table-responsive">
                                            <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="text-center text-muted">
                                                            <asp:Literal ID="literalId" runat="server"></asp:Literal></td>
                                                        <td>
                                                            <div class="widget-content p-0">
                                                                <div class="widget-content-left flex2">
                                                                    <div class="widget-heading">
                                                                        <asp:Literal ID="literalNome" runat="server"></asp:Literal>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        </div>
                                                ...
                                                <td class="text-center">
                                                    <asp:Literal ID="literalTelefone" runat="server"></asp:Literal></td>
                                        <td class="text-center">
                                            <div class="badge badge-warning">
                                                <asp:Literal ID="literalLoja" runat="server"></asp:Literal>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="badge badge-primary">
                                                <asp:Literal ID="literalEvento" runat="server"></asp:Literal>
                                            </div>
                                        </td>
                                        </tr>
                                            </tbody>
