                    ...
                    <div class="scrollbar-sidebar">
                        <div class="app-sidebar__inner">
                            ...
                            <ul class="vertical-nav-menu">
                                <li class="app-sidebar__heading"><a href="Default.aspx"><i class="metismenu-icon fas fa-home"></i>Inicio </a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                                ...
                                                <asp:UpdatePanel ID="upDescarte" runat="server">
                                                    <ContentTemplate>
                                                        <div class="mb-3">
                                                            ...
                                                            <select runat="server" name="ddlVendedor"
                                                                id="ddlVendedorDescarte" runat="server" datasourceid="SqlDataSource1"
                                                                datatextfield="fun_nm" datavaluefield="fun_nm" class="form-control" required="required">
                                                            </select>
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-row">
                                                                        ...
                                                                        <div class="col-md-4 mb-3">
                                                                            ...
                                                                            <select runat="server" name="ddlVendedor"
                                                                                id="ddlVendedor" runat="server" datasourceid="SqlDataSource1"
                                                                                datatextfield="fun_nm" datavaluefield="fun_nm" class="form-control" required="required">
                                                                            </select>
                                                                            <div class="valid-feedback">
                                                                                Ok!
                                                    ...
                                                    <div class="container">
                                                        <div class="row">
                                                            ...
                                                            <asp:SqlDataSource ID="SqlDataSource6" runat="server"
                                                                ConnectionString="<%$ ConnectionStrings:APPConnectionString %>" SelectCommand="SELECT loja,equipe,count(*) as qtde FROM [APP].[dbo].[veiculos_prospeccao]  where nome_evento = 'SEU FIAT EM DIA' group by loja,equipe  order by loja desc"></asp:SqlDataSource>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="main-card mb-3 card">
                                            <div class="card-header-tab card-header-tab-animation card-header mb-3">
                                                ...
                                                <ul class="nav">
                                                    <li class="nav-item">
                                                        <select class="custom-select text-uppercase" runat="server" name="ddlVendedor"
                                                        ...
                                                        <div class="container-fluid mb-3 ">
                                                            ...
                                                            <ul class="list-group">
                                                                ...
                                                                <button class="list-group-item-action list-group-item text-uppercase">
                                                                    ...
                                                                    <b class="mb-3">
                                                                        <asp:Label runat="server" ID="txtCarroLead"></asp:Label></b></button>
