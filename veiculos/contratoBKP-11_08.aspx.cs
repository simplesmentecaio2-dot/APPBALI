    ...
    protected void btnGravar_Click(object sender, EventArgs e)
    {
        ...
        if (rBtnModPagFinanciamento.Checked || rBtnModPagVista.Checked)
        {
            ...
            try
            {
                ...
                string contrato = vec.insert_contrato_venda(txtCliente.Text, txtEndereco.Text, txtCEP.Text, txtBairro.Text, txtCidade.Text,
                ...
                if (tipo == "VN")
                {
                    Response.Redirect("Print-ContratoVN.aspx?contrato=" + contrato);
                }
                if (tipo == "VU")
                {
                    Response.Redirect("Print-ContratoVU.aspx?contrato=" + contrato);
                }
            }
            catch (Exception ex)
            {
