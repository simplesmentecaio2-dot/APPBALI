    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="pnlImpressao" runat="server" Visible="true" Style="font-family: Arial; font-size: 9px; margin-top: 34px;" Width="100%" Height="50%">
            ...
            <table border="1" cellspacing="0" style="width: 18.2cm;">
                ...
                <tr>
                    <td><span style="font-size:12px; ">1) Autorizo a BALI AUTOMOVEIS a faturar, em meu nome e CPF/CNPJ, o(s) veículo(s) objeto deste contrato, conforme preço e forma de pagamento acima descritos.<br />
