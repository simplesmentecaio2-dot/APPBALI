<%@ Page Language="C#" AutoEventWireup="true" CodeFile="infLOJAS.aspx.cs" Inherits="veiculos_Recibo_desconto" %>
...
<head runat="server">
    <title>Informações das Lojas Fiat - Bali</title>
        ...
        <div>
                ...
                <table id="table-menu">
                    <tr>
                        ...
                        <asp:Label ID="lblUsuario" CssClass="idUser" runat="server" Text=""></asp:Label>
                            Perfil:
                        <asp:Label ID="lblTipo" CssClass="idUser" runat="server" Style="margin-right: 13px;" Text=""></asp:Label><a class="bali-logout-link" href="/logout.aspx?voltar=/veiculos/loginAppcontrato.aspx">Sair</a></td>
                    </tr>
                </table>
            </div>
            ...
            <div id="menu">
                ...
                <div style="text-align: right; margin-right: 15px;">
                    <asp:Label ID="lblFrmID" runat="server" Text="Informações das Lojas Fiat"></asp:Label>
                </div>
            </div>
...
<fieldset><legend>Informações </legend>
                            ...
                            <br />
                            <img src="../img/imprimir.png" style="width: 30px; cursor: pointer;" onclick="javascript: imprimePanel()" /> <asp:Panel ID="pnlImpressao" runat="server" Width="100%" Height="100%"><div style="width: 19cm; border: 1px solid black; font-family: 'Times New Roman'; padding: 20px;" id="recibo"><div style="text-align: center"><img src="../img/infLOJAS.jpg" /></div>
