                ...
                <div class="app-main__outer" >
                                            ...
                                            <div class="card-body">
                                                <div class="form-row">
                                                    ...
                                                    <div class="input-group col-sm-12 col-md-5 col-lg-3 mb-3">
                                                        ...
                                                        <div class="input-group-append">
                                                            <a href="http://zxing.appspot.com/scan?ret=http://app.bali.com.br/veiculos/patio/registrar.aspx?serie={CODE}" class="btn btn-dark"><i class="fa fa-barcode fa-2x"></i></a>
                                                        </div>
                                                    </div>
                                                    <div class="input-group col-sm-12 col-md-5 col-lg-3 mb-3">
                                                        <div class="input-group-prepend">
                    ...
                    <footer class="fixed-bottom bg-dark">
                        <div class="container text-center text-white mb-2 mt-2">
                            <b>&copy;Desenvolvido por Caio Augusto</b> | Bali JEEP -  LTDA
                        </div>
