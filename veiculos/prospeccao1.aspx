<%@ Page Language="C#" AutoEventWireup="true" CodeFile="prospeccao1.aspx.cs" Inherits="veiculos_contrato" %>
        ...
        function GetConviteQrCode(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#conviteImage').html('<img class="img-fluid" src="./images/' + response.d.Evento +'_'+response.d.Loja+'.jpg" />');
                    $('#labelCliente').html('Nome: <b>'+response.d.Cliente+'</b>');
                    $('#labelEquipeQr').html('Equipe: <b>'+response.d.Equipe+'</b>');
                },
                complete: function() {},
                    ...
                    <div class="app-main__inner">
                        ...
                        <div class="tab-content">
                                                ...
                                                <asp:UpdatePanel ID="upDescarte" runat="server">
                                                    <ContentTemplate>
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="ddlVendedorDescarte" runat="server" name="prospector" required="required" disabled>
                                                        </div>
                                                        <div class=" mb-3">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-row">
                                                                        ...
                                                                        <div class="col-md-4 mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control" id="ddlVendedor" runat="server" name="prospector" required="required" disabled>
                                                                        </div>
                            ...
                            <div class="tab-pane tabs-animation fade show" id="tab-content-2" role="tabpanel">
                                ...
                                <div class="modal fade mt-5 mb-5" id="qrcode" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div style="letter-spacing: 1px;" class="modal-body">
                                                <div class="col-md-10 offset-md-1 col-xl-10 offset-xl-1">
                                                    <div id="labelCliente" ></div>
                                                    <div id="conviteQrCode" class="bg-white">
                                                        
                                                        <div class="text-center">
                                                            <div id="conviteImage"></div>
                                                            <div class="col-8 offset-2" id="qr"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                                ...
                                                <asp:UpdatePanel ID="upFluxo" runat="server">
                                                    <ContentTemplate>
                                                        ...
                                                        <button class="mb-2 mr-2 col-4 btn btn-dark text-right  font-size-lg">
                                                            ...
                                                            <asp:Label ID="lblPercSemInteresse" CssClass="ml-2 badge badge-light col-md-4" runat="server" Text="0%" data-toggle="tooltip" data-placement="top" title="(Sem Interesse * 100)/Total Realizados"></asp:Label>
                                                        </button>
                                                        <br />
                                                        <button class="mb-2 mr-2 col-7 btn btn-primary  font-size-lg">
                                                            Descarte:</button>
                                    ...
                                    <div class="col-md-4">
                                        <div class="main-card mb-3 card">
                                            ...
                                            <div class="container-fluid mb-3 ">
                                                <button class="mb-2 mr-2 btn btn-primary font-size-lg mb-2">SIA<span class="badge badge-light font-size-lg">320</span></button>
                                                <button class="mb-2 mr-2 btn btn-danger font-size-lg mb-2">SAAN<span class="badge badge-light font-size-lg">80</span></button>
                                                <button class="mb-2 mr-2 btn btn-success font-size-lg mb-2">SCIA<span class="badge badge-light font-size-lg">50</span></button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                                ...
                                                <ul class="nav">
                                                    <li class="nav-item">
                                                        <select class="custom-select text-uppercase ml-2" runat="server" name="ddlVendedor"
                                                            id="ddlEventoGeraLead" runat="server" datasourceid="SqlDataSource2"
