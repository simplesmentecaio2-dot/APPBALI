...
public partial class veiculos_Pint_Contrato : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        ContratoAuditoria.Registrar("Fiat", "VD", contrato, Convert.ToString(Session["id"] ?? ""), Convert.ToString(Session["usuario"] ?? ""), Request.UserHostAddress ?? "", Request.RawUrl ?? "", "IMPRIMIR_CONTRATO", "Contrato=" + contrato + "; Tipo=VD; Marca=Fiat; Pagina=Print-ContratoVD.aspx", "", "");
        ...
        {
            ContratoImpressao.RegistrarErro(this, "Fiat", "VD", contrato, ex);
            ContratoImpressao.ExibirContratoNaoLocalizado(this, "./contrato.aspx");
            return;
        }
        ...
        if (modalidade_pagamento == "A")
        {
            ...
            rBtnModPagFinanciamento.Enabled = false;
            rBtnModPagFinanciamento2.Enabled = false;
            rBtnModPagFinanciamento3.Enabled = false;
        }
        else
        {
            ...
            rBtnModPagVista.Enabled = false;
            rBtnModPagVista2.Enabled = false;
            rBtnModPagVista3.Enabled = false;
        }
        ...
        lblVencimentoPromissoria.Text = data; lblDiaPromissoria.Text = data; lblDataEmissao.Text = data; lblNomeEmitente.Text = cliente;
        ...
        lblVencimentoPromissoria2.Text = data; lblDiaPromissoria2.Text = data; lblDataEmissao2.Text = data; lblNomeEmitente2.Text = cliente;
        ...
        lblVencimentoPromissoria3.Text = data; lblDiaPromissoria3.Text = data; lblDataEmissao3.Text = data; lblNomeEmitente3.Text = cliente;
