   ...
   protected void btnGerar_Click(object sender, EventArgs e)
    {
       ...
       try
        {
            AdmFinanceiro oAdmFinanceiro = new AdmFinanceiro();
            string veiculo, chassi, cor, cliente, placa, ano, nota, vendedor;
            double valor;
            oAdmFinanceiro.select_dadosentrega(txtPedido.Text, out cliente, out veiculo, out chassi, out cor, out placa, out vendedor, out valor, out ano, out nota);
