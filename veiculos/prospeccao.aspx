...
<body>
                                        ...
                                        <div class="btn-group">
                                            <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                                ...
                                                <i class="">
                                                    ...
                                                    <asp:label runat="server" text="" id="lblusuario" visible="false"></asp:label>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div id="conviteQrCode" style="letter-spacing: 1px;" class="modal-body">
                                                <div class="badge badge-light container">
                                                    ...
                                                    <br />
                                                    <div class="text-center">
                                                        <label>Com esse QRCODE você é o nosso convidado especial para as Ofertas!</label>
                                                    </div>
                                                    <div class="text-center">
                                            ...
                                            <div class="col-md-8">
                                                <div class="main-card mb-3 card">
                                                    ...
                                                    <div class="flex" style="height: 420px;">
                                                        <div class="funnel container-fluid m-2">
                                                        </div>
                                                    </div>
                                                            ...
                                                            <ul class="list-group">
                                                                ...
                                                                <div class="input-group row">
                                                                    ...
                                                                    <select class="custom-select text-uppercase" runat="server" id="ddlClassificacaoLead">
                                                                        ...
                                                                        <option value="TELEFONE DESLIGADO"></option>
                                                                        <option value="LIGACAO RECUSADA"></option>
                                                                        <option value="NAO ATENDEU"></option>
                                                                        <option value="NÃO QUER SER INCOMODADO"></option>
                                                                        <option value="COMPROU RECENTEMENTE"></option>
                                                                        <option value="COMPROU NA CONCORRÊNCIA"></option>
                                                                        <option value="FALECEU"></option>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div id="conviteQrCodeLead" style="letter-spacing: 1px;" class="modal-body text-center">
                                                                    <div class="badge badge-light">
                                                                        ...
                                                                        <div class="text-center">
                                                                            <label>CONVITE ESPECIAL PARA VOCÊ, TRAGA O QRCORDE NO DIA DO EVENTO!!</label>
                                                                        </div>
                                                                        <div class="text-center">
    ...
    <script src="js/funnel-graph.min.js"></script>
    <script>
        function gerarFunil(ligacoes, confirmados, fluxo, venda){
            var data = {
                labels: ['Toral de ligações', 'Confirmados(Quente + Frio)', 'Projeção de fluxo','Projeção de venda'],
                colors: ['black', 'blue' , 'yellow', 'gray'],
                sublabels: [ligacoes, confirmados, fluxo, venda],
                values: [ligacoes, confirmados, fluxo, venda]
            };
