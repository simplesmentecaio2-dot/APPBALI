        ...
        <div class="container-login100" style="background-image: url('images/background-2462430_1920.jpg');">
            <div class="wrap-login100 p-t-30 p-b-50">
                <span class="login100-form-title p-b-41">
                    <img src="../img/logobali.png" class="img-fluid" />
                </span>
                <form class="login100-form validate-form p-b-33 p-t-5 text-center" runat="server">

                    <h2 class="text-danger text-uppercase" id="titulo" runat="server">Parabéns, <asp:Literal ID="literalCliente" runat="server"></asp:Literal></h2>
