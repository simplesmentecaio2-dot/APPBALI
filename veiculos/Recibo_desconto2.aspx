<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Recibo_desconto2.aspx.cs" Inherits="veiculos_Recibo_desconto" %>
                        ...
                        <fieldset>
                            ...
                            <asp:Panel ID="pnlImpressao" runat="server" Width="100%" Height="100%">
                                <div style="width: 19cm; border: 1px solid black; font-family: 'Times New Roman'; padding: 20px;" id="recibo">
                                    ...
                                    <br />
                                    <br />
                                    <div style="text-align: center; font-size: 26px; font-weight: bold;">Recibo de Desconto</div>
                                    <br />
                                    <br />
                                    <br />
                                    <div style="font-size: large; text-align: center">
                                        Recebi da
                                        <asp:Label ID="Label1" Font-Bold="True" runat="server" Text="BALI BRASÍLIA AUTOMÓVEIS LTDA"></asp:Label>
...
referente à compra do veículo:
                                        ...
                                        <asp:Label ID="Label2" Font-Bold="True" runat="server" Text="BALI BRASÍLIA AUTOMÓVEIS LTDA"></asp:Label>
