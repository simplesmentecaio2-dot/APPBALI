<%@ WebHandler Language="C#" Class="VeiculosCentralLinksHandler" %>
...
public class VeiculosCentralLinksHandler : IHttpHandler
{
    ...
    {
        return context.Server.MapPath("~/veiculos/central-links.json");
    }
