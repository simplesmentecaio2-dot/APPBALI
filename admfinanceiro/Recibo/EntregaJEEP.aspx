...
<body class="bali-utility-page utility-jeep utility-no-sidebar delivery-receipt-page">
                            ...
                            <asp:TabPanel Style="padding: 20px;" runat="server" HeaderText="TabPanel1"
                                ...
                                <contenttemplate>
                                    <fieldset class="delivery-query-card">
                                        ...
                                        <button type="button" class="delivery-inline-back" onclick="if (window.history.length > 1) { window.history.back(); } else { window.location.href='../../jeep/Principal.aspx'; }">Voltar</button>
