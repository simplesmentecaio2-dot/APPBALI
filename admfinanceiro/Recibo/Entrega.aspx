<%@ page language="C#" autoeventwireup="true" codefile="Entrega.aspx.cs" inherits="admfinanceiro_Recibo_Entrega" %>
...
<head runat="server">
    ...
    <link href="../../css/entrega-veiculo.css?v=20260708-entrega07" rel="stylesheet" />
    <script src="../../js/jquery-1.10.2.js"></script>
    <script src="../../js/js.js"></script>
    <script src="../../js/bali-utility-print.js?v=20260708-entrega07"></script>

</head>

<body class="bali-utility-page utility-fiat utility-no-sidebar delivery-receipt-page">
    <form id="form1" runat="server">
        ...
        <div id="menu">
            <button type="button" class="bali-back-button" onclick="if (window.history.length > 1) { window.history.back(); } else { window.location.href='../../veiculos/Default.aspx'; }">&larr; Voltar</button>
                    ...
                    <td style="width: 100%;">
                        ...
                        <asp:tabcontainer id="TabContainerProcesso" cssclass="tabPanelConsultar"
                            ...
                            <asp:TabPanel Style="padding: 20px;" runat="server" HeaderText="TabPanel1"
                                ...
                                <contenttemplate>
                                    <fieldset class="delivery-query-card">
                                        <legend>Consulta da entrega</legend>Pedido:
                                        <button type="button" class="delivery-inline-back" onclick="if (window.history.length > 1) { window.history.back(); } else { window.location.href='../../veiculos/Default.aspx'; }">Voltar</button>
                                        <asp:TextBox ID="txtpedido" runat="server" MaxLength="12"></asp:TextBox>
                                        Cód. Loja:
                                        <asp:TextBox ID="txtLoja" runat="server" MaxLength="3"></asp:TextBox>
                                        <asp:Button ID="btnGerar" runat="server" Text="Gerar" OnClick="btnGerar_Click" CssClass="btns" />
                                        <asp:Button ID="btnLimpar" runat="server" Text="Limpar" OnClick="btnLimpar_Click" CausesValidation="false" CssClass="btns" />
                                                ...
                                                <section class="delivery-part">
                                                    ...
                                                    <div class="delivery-main-grid">
                                                        ...
                                                        <div class="delivery-portaria">
                                                            ...
                                                            <strong>Visto Portaria / BALI FIAT</strong>
                                                        </div>
                                                    </div>
                                                    <div class="delivery-sign-grid">
                                                        ...
                                                        <div class="delivery-sign-box">
                                                            ...
                                                            <div class="delivery-line"></div>
                                                            <strong>Gerente Novos/Seminovos / BALI FIAT</strong>
                                                            <div class="delivery-line"></div>
