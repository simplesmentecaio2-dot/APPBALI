<%@ WebHandler Language="C#" Class="AdmFinanceiroCentralLinksHandler" %>
...
public class AdmFinanceiroCentralLinksHandler : IHttpHandler
{
    ...
    {
        return context.Server.MapPath("~/admfinanceiro/central-links.json");
    }
